...
!function() {
    ...
    var D = Object.freeze({
      ...
      , A = null;
    function j(t, e) {
        Pi() && t && "string" == typeof t && t.length < 255 && (A = e && "string" == typeof e && e.length < 255 ? {
            key: t,
            value: e
        } : {
            value: t
    ...
    function B() {
        ...
        Pr(25),
        R.gap < 3e5 ? F = X(B, U) : Li && (j("clarity", "suspend"),
        eo(),
        ["mousemove", "touchstart"].forEach((function(t) {
            return Ni(document, t, Xi)
        }
        )),
        ["resize", "scroll", "pageshow"].forEach((function(t) {
            return Ni(window, t, Xi)
        }
        )))
    }
    var J = Object.freeze({
    ...
    var ce = Object.freeze({
        ...
        add: function(t, e, n, a) {
            var r, i = Jt(t, !0), u = e ? Jt(e) : null, c = oe(t), s = null, l = Wa(t) ? i : null, d = qt.has(t) ? qt.get(t) : null, f = o.content ? 1 : 3;
            u >= 0 && Ct[u] && ((s = Ct[u]).children.push(i),
            l = null === l ? s.region : l,
            d = null === d ? s.metadata.fraud : d,
            f = s.metadata.privacy),
            n.attributes && "data-clarity-region"in n.attributes && (Pa(t, n.attributes["data-clarity-region"]),
            l = i),
            It.set(i, t),
            Ct[i] = {
                id: i,
            ...
            function(t, e, n) {
                ...
                case "*T" === u:
                    ...
                    r.privacy = p.includes(f) || jt.some((function(t) {
            ...
            Qt(Ct[i]),
            "IMG" === (r = Ct[i]).data.tag && 3 === r.metadata.privacy && (r.metadata.size = []),
            ue(i, a)
        },
        get: ee,
        getId: Jt,
    ...
    function me() {
        ...
        t.task().then((function() {
            ...
            t.id === ii() && (e && kr(0, 1, e.name, e.message, e.stack),
            fe = null,
            me())
        }
        )))
    ...
    function gn(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== pn && null !== hn.start && n !== e.anchorNode && (Y(vn),
            mn(21)),
            hn = {
                start: e.anchorNode,
    ...
    function xn(t) {
        !function(t) {
            var e = Kt(t);
            Ni(e ? e.contentWindow : t === document ? window : t, "scroll", sn, !0)
        }(t),
        t.nodeType === Node.DOCUMENT_NODE && (je(t),
        function(t) {
            Ni(t, "cut", Xe.bind(this, 0), !0),
            Ni(t, "copy", Xe.bind(this, 1), !0),
            Ni(t, "paste", Xe.bind(this, 2), !0)
        }(t),
        function(t) {
            Ni(t, "mousedown", Ze.bind(this, 13, t), !0),
            Ni(t, "mouseup", Ze.bind(this, 14, t), !0),
            Ni(t, "mousemove", Ze.bind(this, 12, t), !0),
            Ni(t, "wheel", Ze.bind(this, 15, t), !0),
            Ni(t, "dblclick", Ze.bind(this, 16, t), !0),
            Ni(t, "touchstart", Qe.bind(this, 17, t), !0),
            Ni(t, "touchend", Qe.bind(this, 18, t), !0),
            Ni(t, "touchmove", Qe.bind(this, 19, t), !0),
            Ni(t, "touchcancel", Qe.bind(this, 20, t), !0)
        }(t),
        function(t) {
            Ni(t, "input", Fe, !0)
        }(t),
        function(t) {
            Ni(t, "selectstart", gn.bind(this, t), !0),
            Ni(t, "selectionchange", gn.bind(this, t), !0)
        }(t),
        function(t) {
            Ni(t, "change", _e, !0)
        }(t),
    ...
    var _n = Object.freeze({
        ...
        start: function() {
            ...
            Ni(window, "resize", nn),
            nn(),
            Ni(document, "visibilitychange", Nn),
            Nn(),
            rn = [],
            sn(),
            yn(),
        ...
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(s) {
                ...
                case 2:
                    ...
                    s.label = 3;
                case 3:
                    return 2 === u ? [3, 4] : ((c = ta(i, n, a)) && r.push(c),
                    [3, 1]);
                case 4:
                    return [2]
                }
    ...
    function Yn() {
        ...
        Wn = 0,
        Xn = {},
        null === An && (An = CSSStyleSheet.prototype.insertRule,
        CSSStyleSheet.prototype.insertRule = function() {
            return Pi() && Bn(this.ownerNode),
            An.apply(this, arguments)
        }
        ),
        "CSSMediaRule"in window && null === Ln && (Ln = CSSMediaRule.prototype.insertRule,
        CSSMediaRule.prototype.insertRule = function() {
            return Pi() && Bn(this.parentStyleSheet.ownerNode),
            Ln.apply(this, arguments)
        }
        ),
        null === jn && (jn = CSSStyleSheet.prototype.deleteRule,
        CSSStyleSheet.prototype.deleteRule = function() {
            return Pi() && Bn(this.ownerNode),
            jn.apply(this, arguments)
        }
        ),
        "CSSMediaRule"in window && null === zn && (zn = CSSMediaRule.prototype.deleteRule,
            ...
            return rt(this, (function(f) {
                ...
                case 4:
                    if (2 === u)
                        return [3, 6];
                    switch (c = i.target,
                    l = o.throttleDom ? function(t, e, n, a) {
                        ...
                        if (r && "HTML" !== r.data.tag) {
                            ...
                            var s = Xn[c];
                            if (!1 === i && s[0] >= 10 && Vn(s[2], 2, e, a),
                            s[0] = i ? s[1] === n ? s[0] : s[0] + 1 : 1,
                            s[1] = n,
                            10 === s[0])
                                return s[2] = t.removedNodes,
                                "suspend";
                            if (s[0] > 10)
                                return ""
                        }
                    ...
                    l && c && c.nodeType == Node.DOCUMENT_FRAGMENT_NODE && c.host && Bt(c),
                    l) {
                    case "attributes":
                        ta(c, 3, e.time);
                        break;
                    case "characterData":
                        ...
                        break;
                    case "childList":
                        Vn(i.addedNodes, 1, t, e.time),
                        Vn(i.removedNodes, 2, t, e.time);
                        break;
                    case "suspend":
        ...
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(u) {
                ...
                case 0:
                    ...
                    u.label = 1;
                case 1:
                    return i < r ? 1 !== e ? [3, 2] : (In(t[i], n, e, a),
                    [3, 5]) : [3, 6];
                case 2:
    ...
    function Bn(t) {
        return Hn.indexOf(t) < 0 && Hn.push(t),
        Pn && Y(Pn),
        Pn = X((function() {
            !function() {
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r)
                ...
                case "product":
                    ...
                    Gr(10, t.name),
                    Gr(12, t.sku),
                    t.brand && Gr(6, t.brand.name);
                    break;
                case "aggregaterating":
                    t.ratingValue && (W(11, Zn(t.ratingValue, 100)),
                    W(18, Zn(t.bestRating)),
                    W(19, Zn(t.worstRating))),
                    W(12, Zn(t.ratingCount)),
                    W(17, Zn(t.reviewCount));
                    break;
                case "person":
                    Gr(8, t.name);
                    break;
                case "offer":
                    Gr(7, t.availability),
                    Gr(14, t.itemCondition),
                    Gr(13, t.priceCurrency),
                    Gr(12, t.sku),
                    W(13, Zn(t.price));
                    break;
                case "brand":
    ...
    function ta(t, e, n) {
        ...
        case Node.TEXT_NODE:
            if (o = o || t.parentNode,
            "update" === i || o && ae(o) && "STYLE" !== o.tagName && "NOSCRIPT" !== o.tagName) {
                var f = {
                    tag: "*T",
                    value: t.nodeValue
                };
        ...
        case Node.ELEMENT_NODE:
            ...
            case "IFRAME":
                ...
                Gt(T) && (!function(t) {
                    !1 === ae(t) && Ni(t, "load", Jn.bind(this, t, "childList"), !0)
                }(T),
                N.attributes["*O"] = "true",
    ...
    function na(t) {
        ...
        return (0 === e.length || n > 0 || t.id.length > 0) && (e = aa(t.sheet)),
        e
    }
    function aa(t) {
        var e = ""
            ...
            if (null !== a && n.getKeyframes && n.getTiming) {
                if (!t[Sa]) {
                    ...
                    var r = n.getKeyframes()
                      , i = n.getTiming();
                    Na(s(), t[Sa], 0, JSON.stringify(r), JSON.stringify(i), a)
                }
                if (t[Ea]++ < Oa) {
                    var o = null;
                    switch (e) {
    ...
    function _a(t, e, n) {
        ...
        void 0 === n && (n = null),
        at(this, void 0, void 0, (function() {
            var a, r, i, u, c, l, d, f, h, p, v, g, y, b, w, k, S, E, O, T, N, M, I, C, D, A, j, R, L;
                    ...
                    D = T ? ["tag", "attributes", "value"] : ["tag"]; C < D.length; C++)
                        if (O[A = D[C]])
                            ...
                            case "tag":
                                ...
                                r.push(N ? "*M" : O[A]),
                                j && 2 === j.length && r.push("".concat("#").concat(Ca(j[0]), ".").concat(Ca(j[1])));
                                break;
                            case "attributes":
                                for (L in O[A])
                                    void 0 !== O[A][L] && r.push(Da(L, O[A][L], M));
                                break;
                            case "value":
    ...
    var Aa = []
      ...
      , Ha = null;
    function Pa(t, e) {
        !1 === ja.has(t) && (ja.set(t, e),
        (Ha = null === Ha && za ? new IntersectionObserver(Ya,{
    ...
    function Ya(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            var a = n[e]
              ...
              , u = a.rootBounds;
            if (ja.has(r) && i.width + i.height > 0 && u.width > 0 && u.height > 0) {
                var c = r ? Jt(r) : null
                  , s = c in Ra ? Ra[c] : {
                    id: c,
                    name: ja.get(r),
                ...
                qa(r, s, s.interaction, d ? 13 : l ? 10 : 0),
                s.visibility >= 13 && Ha && Ha.unobserve(r)
            }
        }
        Aa.length > 0 && _a(7)
    }
    function qa(t, e, n, a) {
        ...
        e.id ? (e.id in Ra && r || !(e.id in Ra)) && (Ra[e.id] = e,
        Aa.push(Ua(e))) : La.push({
            node: t,
            state: Ua(e)
        })
    }
    ...
    function Ja(t, e) {
        return void 0 === e && (e = null),
        at(this, void 0, void 0, (function() {
            var n, a, r, i, o, u, c, l, d, f, h, p, v, g, b, w, k, S, E, O, T, N, M, _, C, D, A, j, R, L, z, H, P, W, X;
            return rt(this, (function(Y) {
                ...
                case 20:
                    ...
                    i = Ge; r < i.length; r++)
                        W = i[r],
                        (o = Ba(W.data.target, W.event)).id > 0 && ((a = [W.time, W.event]).push(o.id),
                        a.push(W.data.x),
                        a.push(W.data.y),
                        sr(a),
                ...
                case 9:
                    ...
                    c = Ae; u < c.length; u++)
                        W = c[u],
                        l = Ba(W.data.target, W.event, W.data.text),
                        a = [W.time, W.event],
                        ...
                        a.push(W.data.trust),
                        sr(a),
                        Qa(W.time, W.event, d, W.data.x, W.data.y, W.data.reaction, W.data.context);
                    Pe();
                    break;
                case 38:
                    for (f = 0,
                    h = We; f < h.length; f++)
                        W = h[f],
                        a = [W.time, W.event],
                        (z = Ba(W.data.target, W.event)).id > 0 && (a.push(z.id),
                ...
                case 27:
                    ...
                    b = Ue; g < b.length; g++)
                        W = b[g],
                        w = Ba(W.data.target, W.event, W.data.value),
                ...
                case 10:
                    ...
                    T = rn; O < T.length; O++)
                        W = T[O],
                        N = Ba(W.data.target, W.event),
                        M = Ba(W.data.top, W.event),
                        _ = Ba(W.data.bottom, W.event),
                ...
                case 42:
                    ...
                    j = xe; A < j.length; A++)
                        W = j[A],
                        a = [W.time, W.event],
                        (z = Ba(W.data.target, W.event)).id > 0 && ((a = [W.time, W.event]).push(z.id),
                        a.push(W.data.type),
    ...
    var $a, tr, er, nr, ar, rr = 0, ir = 0, or = null, ur = 0;
    function cr() {
        nr = !0,
        rr = 0,
        ir = 0,
    ...
    function dr(t) {
        ...
        at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(l) {
                ...
                case 0:
                    return or = null,
                    (e = !1 === o.lean && ir > 0 && (ir < 1048576 || yi.sequence > 0)) && W(1, 1),
                    Xa(),
                    function() {
                        var t = [];
                        Ka = [];
                ...
                case 2:
                    ...
                    l.label = 3;
                case 3:
                    return P(2, (c = s) ? c.length : u.length),
                    fr(u, c, yi.sequence, n),
                    tr = [],
                    e && ($a = [],
                    ir = 0,
                    rr = 0),
    ...
    function hr(t, e) {
        var n = er[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? Yr(6) : (0 === t.status && (o.upload = o.fallback ? o.fallback : o.upload),
        fr(n.data, null, e)) : (ar = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        ...
        0 === t.status && (fr(n.data, null, e, !0),
        Yr(3)),
        t.status >= 200 && t.status <= 208 && pr(e),
        delete er[e]))
    }
    function pr(t) {
        1 === t && ci()
    ...
    function mr(t) {
        var e = t.error || t;
        return e.message in gr || (gr[e.message] = 0),
        gr[e.message]++ >= 5 || e && e.message && (vr = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function kr(t, e, n, a, r) {
        ...
        t in wr ? wr[t].push(i) : wr[t] = [i],
        yr(33))
    }
    var Sr, Er = {}, Or = new Set, Tr = {}, Nr = {}, Mr = {}, xr = {};
    function _r() {
        Ar()
    }
    function Ir(t) {
            ...
            for (var t in Tr) {
                ...
                if ("" == xr[e] || document.querySelector(xr[e])) {
                    ...
                    for (var u in o) {
                        ...
                        if (s)
                            jr(e, c, Array.from(s).map((function(t) {
                    ...
                    for (var d in l) {
                        var f = parseInt(d);
                        jr(e, f, $t(l[f]).trim().substring(0, 1e4))
                    }
                }
            }
            Or.size > 0 && Pr(40)
    ...
    function jr(t, e, n) {
        ...
        r = !0),
        a = Mr[t],
        0 == Object.keys(a).length || e in Er[t] && Er[t][e] == n || (r = !0),
        Er[t][e] = n,
        r && Or.add(t)
    }
    function Rr() {
    ...
    function Xr(t) {
        if (0 === Sr.check) {
            var e = Sr.check;
            e = yi.sequence >= 128 ? 1 : e,
            e = yi.pageNum >= 128 ? 7 : e,
            e = s() > 72e5 ? 2 : e,
            (e = t > 10485760 ? 2 : e) !== Sr.check && Yr(e)
        }
    }
    function Yr(t) {
        Sr.check = t,
    ...
    function Gr(t, e) {
        e && (e = "".concat(e),
        t in Fr || (Fr[t] = []),
        Fr[t].indexOf(e) < 0 && (Fr[t].push(e),
        t in Vr || (Vr[t] = []),
        Vr[t].push(e),
        Fr[t].length > 128 && Yr(5)))
    }
    function Kr() {
        Pr(1)
    }
    ...
    function ni() {
        ...
        Gr(0, a),
        Gr(3, c),
        Gr(1, y(location.href, !!ti)),
        Gr(2, document.referrer),
        Gr(15, function() {
            var t = di();
        ...
        Gr(16, document.documentElement.lang),
        Gr(17, document.dir),
        Gr(26, "".concat(window.devicePixelRatio)),
        Gr(28, f.dob.toString()),
        Gr(29, f.version.toString()),
        Gr(33, u),
        Gr(34, r),
        Gr(35, i),
        W(0, l.ts),
        W(1, 0),
        W(35, ti),
        navigator && (Gr(9, navigator.language),
        ...
        )) : Gr(22, navigator.platform)),
        screen && (W(14, Math.round(screen.width)),
    ...
    function oi(t) {
        ...
        !t)
            return o.track = !1,
            gi("_clsk", "", -Number.MAX_VALUE),
            gi("_clck", "", -Number.MAX_VALUE),
            eo(),
            ...
            !function(t) {
                if ($r.length > 0)
                    for (var e = 0; e < $r.length; e++) {
                        var n = $r[e];
                        !n.callback || n.called || n.wait && !t || (n.callback(Qr, !o.lean),
                        n.called = !0,
                        n.recall || ($r.splice(e, 1),
                        e--))
                    }
            }(n),
            gi("_clsk", [Qr.sessionId, t, Qr.pageNum, n, e].join("|"), 1)
        }
    }
    function si(t, e) {
        try {
    ...
    function hi() {
        ...
        if (e && e.length > 0) {
            ...
            n.length > 1 && (t.version = fi(n[1])),
            n.length > 2 && (t.expiry = fi(n[2], 36)),
            n.length > 3 && 1 === fi(n[3]) && (t.consent = 1),
            n.length > 4 && fi(n[1]) > 1 && (t.dob = fi(n[4])),
            ...
            if (n)
                for (var a = 0; a < n.length; a++) {
                    ...
                    if (r.length > 1 && r[0] && r[0].trim() === t) {
                        for (var i = vi(r[1]), o = i[0], u = i[1]; o; )
                            o = (e = vi(u))[0],
                            u = e[1];
                        return u
                    }
    ...
    function ki(t) {
        return yi.start = yi.start + yi.duration,
        yi.duration = s() - yi.start,
        yi.sequence++,
        yi.upload = t && "sendBeacon"in navigator ? 1 : 0,
        yi.end = t ? 1 : 0,
        [yi.version, yi.sequence, yi.start, yi.duration, yi.projectId, yi.userId, yi.sessionId, yi.pageNum, yi.upload, yi.end]
    }
    function Si() {
        mi = []
    }
    ...
    function zi() {
        ...
        Ii = Ri(),
        Ci = 0,
        Ni(window, "popstate", Ai),
        null === xi && (xi = history.pushState,
        history.pushState = function() {
            xi.apply(this, arguments),
            Pi() && Di() && Ai()
        }
        ),
        null === _i && (_i = history.replaceState,
    ...
    var Ui = Object.freeze({
        ...
        start: function() {
            ...
            Ra = {},
            La = [],
            za = !!window.IntersectionObserver,
            Ut(),
            o.delayDom ? Ni(window, "load", (function() {
                Yn()
            }
            )) : Yn(),
            ge(qi, 1).then((function() {
                Oi(Me)(),
                Oi(Xa)(),
                Oi(fn)()
            }
            )),
            null === oa && (oa = CSSStyleSheet.prototype.replace,
            CSSStyleSheet.prototype.replace = function() {
                return Pi() && (W(36, 1),
                this[sa] === Qr.pageNum && va(s(), this[ca], 1, arguments[0])),
                oa.apply(this, arguments)
            }
            ),
            null === ua && (ua = CSSStyleSheet.prototype.replaceSync,
            CSSStyleSheet.prototype.replaceSync = function() {
                return Pi() && (W(36, 1),
                this[sa] === Qr.pageNum && va(s(), this[ca], 2, arguments[0])),
                ua.apply(this, arguments)
            }
            ),
            function() {
                if (window.Animation && window.KeyframeEffect && window.KeyframeEffect.prototype.getKeyframes && window.KeyframeEffect.prototype.getTiming && (Ta(),
                Ma(ya, "play"),
                Ma(ba, "pause"),
                Ma(wa, "cancel"),
                Ma(ka, "finish"),
                null === ma && (ma = Element.prototype.animate,
                ...
                document.getAnimations))
                    for (var t = 0, e = document.getAnimations(); t < e.length; t++) {
                        var n = e[t];
                        "finished" === n.playState ? xa(n, "finish") : "paused" === n.playState || "idle" === n.playState ? xa(n, "pause") : "running" === n.playState && xa(n, "play")
                    }
            }()
        },
        stop: function() {
        ...
        function(t) {
            at(this, void 0, void 0, (function() {
                ...
                return rt(this, (function(a) {
                    return e = s(),
                    n = [e, t],
                    29 === t && (n.push(Vi.fetchStart),
                    n.push(Vi.connectStart),
                    n.push(Vi.connectEnd),
                    n.push(Vi.requestStart),
                    n.push(Vi.responseStart),
                    n.push(Vi.responseEnd),
                    n.push(Vi.domInteractive),
                    n.push(Vi.domComplete),
                    n.push(Vi.loadEventStart),
                    n.push(Vi.loadEventEnd),
                    n.push(Vi.redirectCount),
                    n.push(Vi.size),
                    n.push(Vi.type),
                    n.push(Vi.protocol),
                    n.push(Vi.encodedSize),
                    n.push(Vi.decodedSize),
                    Bi(),
                    sr(n)),
                    [2]
                }
    ...
    function Ki() {
        try {
            Fi && Fi.disconnect(),
            Fi = new PerformanceObserver(Oi(Zi));
            for (var t = 0, e = Gi; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && P(9, 0),
                Fi.observe({
                    type: n,
                    buffered: !0
                }))
    ...
    var $i = [Yi, Ui, _n, Object.freeze({
        ...
        start: function() {
            ...
            function() {
                ...
                window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? Ni(window, "load", X.bind(this, Ki, 0)) : Ki() : kr(3, 0)
            }()
        },
        stop: function() {
            Fi && Fi.disconnect(),
    ...
    function eo() {
        ...
        wt(),
        Hi(),
        void 0 !== ao && (ao[ro] = function() {
            (ao[ro].q = ao[ro].q || []).push(arguments),
    ...
    var no = Object.freeze({
        ...
        pause: function() {
            Pi() && (j("clarity", "pause"),
            null === he && (he = new Promise((function(t) {
                pe = t
            }
            ))))
        },
    ...
    function io() {
        if (void 0 !== ao) {
            ...
            ,
            ao[ro].v = l; t.length > 0; )
                ao[ro].apply(ao, t.shift())
        }
    }
    io()
}();
